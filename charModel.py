# -*- coding: utf-8 -*-
"""
Created on Mon Sep 11 11:36:21 2023
...
##Lectura y procesamiento del texto
...
char2int = {ch:i for i,ch in enumerate(chars_sorted)} #map caracter-indice
char_array = np.array(chars_sorted)

text_encoded = np.array(
    [char2int[ch] for ch in text],#valores codificados de todos los caracteres
    dtype=np.int32)               #del texto
...
##Para la generación de caracteres, tockenizamos? el texto primero
seq_length = 40
...
##Ahora transformamos el conjunto de datos en minilotes
batch_size = 64
torch.manual_seed(1)
...
##Creación de la función de pérdida y un optimizador
